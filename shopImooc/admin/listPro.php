...
$pageSize=2;
$rows=getProByPage($pageSize,$where,$orderBy);
if (!$rows){
    alertMes("没有商品，请添加","addPro.php");
    exit;
}
?>
<!doctype html>
...
<div class="details">
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                                ...
                                <td align="center">
					                        	...
					                        	<table class="table" cellspacing="0" cellpadding="0">
					                        		...
					                        		<tr>
					                        			...
					                        			<td>
                                                            <?php
                                                            $proImgs=getProImageByPid($row['id']);
                                                            ?>
                                                            <?php if($proImgs):?>
                                                                <?php
                                                                foreach ($proImgs as $proImg):
                                                                    ?>
                                                                    <img width="100" height="100" src="uploads/<?php echo $proImg['albumPath'];?>" alt="无法显示"/>&nbsp;&nbsp;
                                                                <?php endforeach; ?>
                                                                <?php else:?>
                                                                <div>暂无图片</div>
                                                            <?php endif;?>
                        ...
                        <?php if ($rows>$pageSize) :?>
                            <tr>
                                <td colspan="7"><?php echo showPage($page,$toalPage,"keywords={$keywords}&order={$order}");?></td>
                            </tr>
                        <?php endif;?>
                        </tbody>
                    </table>
